...
CREATE TABLE IF NOT EXISTS posts (
  ...
  CONSTRAINT author_fr FOREIGN KEY (author) REFERENCES users (_id)
);
CREATE TABLE IF NOT EXISTS follows (
  followedId int NOT NULL,
  authorId int NOT NULL,
  PRIMARY KEY (followedId,authorId),
  KEY authorid_fk_idx (authorId),
  CONSTRAINT authorid_fk FOREIGN KEY (authorId) REFERENCES users (_id),
  CONSTRAINT followed_fk FOREIGN KEY (followedId) REFERENCES users (_id)
);
`);
}
